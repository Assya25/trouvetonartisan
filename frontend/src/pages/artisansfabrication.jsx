...
function ArtisansFabrication() {
  ...
  return (
    <main className="artisan-list-page">
      ...
      <section className="category-banner fabrication-banner">
        <h1 className="category-title">ARTISANS FABRICATIONS</h1>
      </section>
      ...
      <section className="artisan-filters">
        ...
        <div className="subfilters">
          <button
            ...
            onClick={() => setSousCategorie('menuis')}
          >
            Menuisier
          </button>
          ...
          <button
            ...
            onClick={() => setSousCategorie('ferron')}
          >
            Ferronier
          </button>
          ...
          <button
            ...
            onClick={() => setSousCategorie('bijout')}
          >
            Bijoutier
          </button>
        </div>
      ...
      <section className="artisan-cards-grid">
        {artisansFiltres.map((artisan, index) => (
          <article key={artisan.id} className="artisan-list-card">
            ...
            <Link to={`/artisan/${artisan.id}`} className="arrow-btn">
              ➜
            </Link>
          </article>
        ))}
...
export default ArtisansFabrication;
