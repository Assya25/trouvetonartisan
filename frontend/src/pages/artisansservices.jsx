...
function ArtisansServices() {
  ...
  return (
    <main className="artisan-list-page">
      ...
      <section className="category-banner services-banner">
        <h1 className="category-title">ARTISANS DES SERVICES</h1>
      </section>
      ...
      <section className="artisan-filters">
        ...
        <div className="subfilters">
          <button
            ...
            onClick={() => setSousCategorie('coiff')}
          >
            Coiffure
          </button>
          ...
          <button
            ...
            onClick={() => setSousCategorie('fleur')}
          >
            Fleuriste
          </button>
          ...
          <button
            ...
            onClick={() => setSousCategorie('toilett')}
          >
            Toilettage
          </button>
        </div>
...
export default ArtisansServices;