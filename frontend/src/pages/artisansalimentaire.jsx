...
function ArtisansAlimentaire() {
  ...
  return (
    <main className="artisan-list-page">
      ...
      <section className="category-banner alimentation-banner">
        <h1 className="category-title">ARTISANS DE L&apos;ALIMENTAIRE</h1>
      </section>
...
>
  →
        ...
        <div className="subfilters">
          <button
  className={`filter-btn filter-dark ${sousCategorie === 'boucher' ? 'selected' : ''}`}
  onClick={() => setSousCategorie('boucher')}
>
  Boucherie
</button>

<button
  className={`filter-btn filter-blue ${sousCategorie === 'boulanger' ? 'selected' : ''}`}
  onClick={() => setSousCategorie('boulanger')}
>
  Boulangerie
</button>

<button
  className={`filter-btn filter-grey ${sousCategorie === 'traiteur' ? 'selected' : ''}`}
  onClick={() => setSousCategorie('traiteur')}
>
  Traiteur
</button>
        </div>
...
export default ArtisansAlimentaire;